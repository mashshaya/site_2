...
async function getResponce() {
    ...
    for (key in content_price) {
                ...
                <li style="width: 200px" class="d-flex flex-column m-1 p-1 border bg-body">
                <img style="width: 150px" class="align-self-center" src=${content[key].img}>
                <h5 class="card-title">${content[key].title}</h5>
                <p class="card-text">${content[key].description} Цена: ${content[key].price} рублей</p>
